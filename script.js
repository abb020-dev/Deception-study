...
let sessionInstructions = {
  ...
  session3: {
    en: "Copy the question and directly paste it into ChatGPT.\nCopy the generated response from ChatGPT and paste it into the the ChatGPT Version input field.\nRetype the response generated by ChatGPT word for word in the Transcribed Version input field, but add in pauses, deletions, and retyping to replicate an authentic typing process.\nRepeat the above steps for each coding exercise and follow up question in this session.\nAnticipated duration: 30-40 minutes.",
...
function startSession() {
  ...
  if (currentSession === 1) {
    ...
    subHeading.textContent = language === 'en' ? 'Deceiving with ChatGPT' : 'ChatGPT 옮겨쓰기';
